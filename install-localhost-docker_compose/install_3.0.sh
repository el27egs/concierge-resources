...
declare -a array=("concierge-debit-accounts_SP3" "concierge-user-management" "concierge-aws-test" "concierge-auth-server" "concierge-api-gateway" "concierge-discovery-service")
